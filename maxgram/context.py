...
class Context:
    ...
    def reply(self, text: str, attachments: Optional[List[Dict[str, Any]]] = None, keyboard: Optional[Any] = None, format: Optional[Literal["markdown", "html"]] = None) -> Dict[str, Any]:
        """
